% Implement 1D CFAR using lagging cells on the given noise 
...and target scenario.
...
for i = 1:(Ns-(G+T))     
    ...
    % 2. - 5. Determine the noise threshold by measuring it 
    ...within the training cells
